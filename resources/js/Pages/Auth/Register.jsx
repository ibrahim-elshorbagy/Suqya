      ...
      <div className="">
        <form onSubmit={submit} className="space-y-6">
          ...
          <Link
            ...
            className="w-full flex justify-center items-center gap-3 px-4 py-2 font-medium text-neutral-700 dark:text-neutral-300 bg-white dark:bg-neutral-700 border border-neutral-300 dark:border-neutral-600 hover:bg-neutral-50 dark:hover:bg-neutral-600 rounded-lg transition-all"
          >
